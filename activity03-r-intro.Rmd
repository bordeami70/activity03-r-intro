...
**Response**:There was an error with a missing comma on the upper_case variable - and an issue with teh quotation marks on the punctuation variable
...
**Response**: dataframe needs to be seperated by a . and names(mysymbols) = Symbol needs to have"
...
**Response**:unexpected input in the variable name my_symbols%Num <- this variable name is not a valid name with "%"
...
```{r}
  new_top_secret = matrix(top_secret,ncol=5)
  evens = seq(2,502,2)
  new_top_secret
